// COMM 6 - Current PC Conection for Ref
...
#define DATA_PIN_CHA 16 // ARDUINO PIN that SPIN RCVRY is connected to
#define NUM_LEDS_CHB 400 // Generic Backlight loop - Left Console (400 LEDS) Change as required
#define DATA_PIN_CHB 17 // ARDUINO PIN that Left Console is connected to
#define NUM_LEDS_CHC 400 // Generic Backlight loop - Right Console (400 LEDS) Change as required
#define DATA_PIN_CHC 18 // ARDUINO PIN that Right Console is connected to
...
CRGB leds_A[NUM_LEDS_CHA]; // LEDS CHAN A
CRGB leds_B[NUM_LEDS_CHB]; // LEDS CHAN B
CRGB leds_C[NUM_LEDS_CHC]; // LEDS CHAN C
