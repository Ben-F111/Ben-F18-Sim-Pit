...
DcsBios::IntegerBuffer clipApuAccLtBuffer(0x74a4, 0x0100, 15, onClipApuAccLtChange);
...
DcsBios::IntegerBuffer clipBattSwLtBuffer(0x74a4, 0x0200, 8, onClipBattSwLtChange);
...
DcsBios::IntegerBuffer clipCkSeatLtBuffer(0x74a0, 0x8000, 14, onClipCkSeatLtChange);
...
DcsBios::IntegerBuffer clipFcesLtBuffer(0x74a4, 0x4000, 13, onClipFcesLtChange);
...
DcsBios::IntegerBuffer clipFcsHotLtBuffer(0x74a4, 0x0400, 9, onClipFcsHotLtChange);
...
DcsBios::IntegerBuffer clipFuelLoLtBuffer(0x74a4, 0x2000, 12, onClipFuelLoLtChange);
...
DcsBios::IntegerBuffer clipGenTieLtBuffer(0x74a4, 0x0800, 10, onClipGenTieLtChange);
...
DcsBios::IntegerBuffer clipLGenLtBuffer(0x74a8, 0x8000, 15, onClipLGenLtChange);
...
DcsBios::IntegerBuffer clipRGenLtBuffer(0x74a8, 0x0200, 8, onClipRGenLtChange);
...
DcsBios::IntegerBuffer clipSpareCtn1LtBuffer(0x74a4, 0x1000, 11, onClipSpareCtn1LtChange);
...
DcsBios::IntegerBuffer clipSpareCtn2LtBuffer(0x74a4, 0x8000, 14, onClipSpareCtn2LtChange);
...
DcsBios::IntegerBuffer clipSpareCtn3LtBuffer(0x74a8, 0x0400, 9, onClipSpareCtn3LtChange);
