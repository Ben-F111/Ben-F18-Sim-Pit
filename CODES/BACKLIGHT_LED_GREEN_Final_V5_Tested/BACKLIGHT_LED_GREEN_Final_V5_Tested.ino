...
//
#define NUM_LEDS_CHE 400 // Generic Backlight loop - LIP (400 LEDS) Change as required
#define DATA_PIN_CHE 48 // ARDUINO PIN that Right Console is connected to
//
#define NUM_LEDS_CHF 400 // Generic Backlight loop - SPARE (400 LEDS) Change as required
