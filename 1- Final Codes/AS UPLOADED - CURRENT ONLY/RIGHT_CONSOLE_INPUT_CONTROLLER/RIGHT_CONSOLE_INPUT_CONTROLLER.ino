...
void SendDCSBIOSMessage(int ind, int state) {
    ...
    case 1:
      ...
      switch (ind) {
        ...
        case 39:
          ...
          case 49:
            break;
          case 50:
          SendIPString("LCTRL F4");// CHASE VIEW
            break;
          // PRESS - CLOSE
          case 51:
     ...
     //   SendIPString("F6");
          ...
          case 122:
            ...
            break;
          case 123:
            // Special Case for Salute
            if (Ethernet_In_Use == 1) {
              SendIPString("LCTRL LSHIFT S");
            }
            break;
          case 124:
  ...
  DcsBios::PotentiometerEWMA<5, 128, 5> ufcComm1Vol("UFC_COMM1_VOL", 13);
  DcsBios::PotentiometerEWMA<5, 128, 5> ufcComm2Vol("UFC_COMM2_VOL", 14);
  DcsBios::PotentiometerEWMA<5, 128, 5> ufcBrt("UFC_BRT", 12);
