...
//sendCommand("bt60.pic1=27"); // Pump 1
//sendCommand("bt0.pic0=28"); //Pump 1 Button
//sendCommand("bt0.pic1=28"); //Pump 1 Button
sendCommand("bt62.pic0=27"); // Chiller
//sendCommand("bt62.pic1=27"); // Chiller

  digitalWrite(pump1Pin, HIGH);
  digitalWrite(chillPin, HIGH);
    } else{
sendCommand("bt60.pic0=24"); // Pump 1
//sendCommand("bt60.pic1=24");//Pump 1
//sendCommand("bt0.pic0=29"); //Pump 1 Button
//sendCommand("bt0.pic1=29"); // Pump 1 Button
sendCommand("bt62.pic0=24"); // Chiller
//sendCommand("bt62.pic1=24"); //Chiller
...
//sendCommand("bt61.pic1=27"); // Pump 2
//sendCommand("bt1.pic0=30"); // Pump 2 Button
//sendCommand("bt1.pic1=30"); // Pump 2 Button
sendCommand("bt63.pic0=27"); //UV
//sendCommand("bt63.pic1=27"); //UV

  digitalWrite(pump2Pin, HIGH);
  digitalWrite(uvPin, HIGH);
    } else{
sendCommand("bt61.pic0=24"); // Pump 2
//sendCommand("bt61.pic1=24"); // Pump 2
//sendCommand("bt1.pic0=31"); // Pump 2 Button
//sendCommand("bt1.pic1=31"); // Pump 2 Button
sendCommand("bt63.pic0=24"); // UV
//sendCommand("bt63.pic1=24"); //UV
