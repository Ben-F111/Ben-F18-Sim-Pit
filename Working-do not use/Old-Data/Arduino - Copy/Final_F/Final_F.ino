...
digitalWrite(drainPin, HIGH); // Sump Drain bit on
...
if (drainPin == true) {
  ...
  digitalWrite(drainPin, LOW);
    dbSerialPrintln("Pin NOT OK"); 
}*/

/*if (sumpdraintog == true){
digitalWrite(sumpdraintog, HIGH);
dbSerialPrintln("drainsump TRUE"); 
}else{
  digitalWrite(sumpdraintog, LOW);
  dbSerialPrintln("drainsump FALSE"); 
}

if (drainsump == HIGH){
digitalWrite(drainPin, HIGH);
dbSerialPrintln("drain Pin OK"); 
}else{
  digitalWrite(drainPin, LOW);
  dbSerialPrintln("drain Pin Not OK"); 
}*/
