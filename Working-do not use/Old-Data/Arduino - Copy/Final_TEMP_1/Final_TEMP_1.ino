...
DeviceAddress Probe01 = { 0x28, 0xFF, 0x7C, 0xB0, 0x86, 0x16, 0x05, 0x5F }; 
DeviceAddress Probe02 = { 0x28, 0xFF, 0xD1, 0x1C, 0x87, 0x16, 0x05, 0x90 };
...
NexDSButton LEDbtn = NexDSButton(0,43,"bt12");
NexDSButton T5btn = NexDSButton(0,42,"bt13");

 uint32_t digitalstate0, digitalstate1, digitalstate2, digitalstate3, digitalstate4, 
 digitalstate5, digitalstate6, digitalstate7, digitalstate8, digitalstate9, digitalstate10,
 digitalstate11, digitalstate12 = 0;
...
int lastButtonState = 0;     // previous state of the button
 ...
 int atoPin = 7;
 int saltPin = 6;
  //***** Relay Outputs Lights *****
 int RadionPin = 23; // LED for now
 int T5tubesPin = 25; // LED for now
...
int atolow = 28;
int topoff = 30;
int topofffull = 42; //new bt42 ID 40
int sumpchg = 32;
int sumphigh = 34;
int sumplow = 36;
int sumplvl = 38;
...
unsigned long ledResetInterval = 1000;    // change names
unsigned long prevFEEDResetMillis = 0;      // change names
unsigned long feedResetInterval = 5000;    // change names
...
{
/*
  int chk = DHTB.read11(DHT11b_PIN);
Serial.print("B Temperature = ");
Serial.println(DHTB.temperature);
 // Serial.print("B Humidity = ");
 // Serial.println(DHTB.humidity);
}
  dht11val = DHTB.temperature;  
  itoa(dht11val,buffer,10);
  //t2.setText(buffer);
t0.setText(buffer);
    yield();}
