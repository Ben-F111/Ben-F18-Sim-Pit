...
unsigned long refreshSenInterval = 500;  // Nextion Indications
...
unsigned long feedResetInterval = 1000;     // Feed Tank // 10 mins
char buffer[10] = {0};
//*********************************************************************************************************************************************************
//***************************************************************** FUNCTION 1 ****************************************************************************
void doFunction1()
...
/*
  ...
  //***************************************************************** TANK ALARM ***************************************************************************
  // Tank OK
  if (sump == HIGH || socksblk == LOW || topfull == HIGH || pump1sw == HIGH || pump2sw == HIGH ) {
